...
interface CartProps {
  ...
  onCheckout: (comments: string, status: string) => void; 
}
...
export const Cart: React.FC<CartProps> = ({
  ...
  const handleCheckout = (status: string) => {
    onCheckout(comments, status); // Llama al callback `onCheckout` con los comentarios y el estado
  };
      ...
      {items.length === 0 ? (
        ...
        <>
          ...
          <div className="mt-4 flex justify-end gap-4">
            ...
            <button
              onClick={() => handleCheckout('partial')} 
...
//   onGenerateInvoice, // Función para generar la factura
// }) => {
...
//       onGenerateInvoice('pending', { comments });
//     }
//   };
